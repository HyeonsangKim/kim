...
public class Index extends AppCompatActivity implements View.OnClickListener ,NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView wis = findViewById(R.id.wis);
        ImageView sy = findViewById(R.id.sy);
        ImageView sc = findViewById(R.id.sc);
        ImageView gy = findViewById(R.id.gy);
        ...
        gy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent it4 = new Intent(getApplicationContext(), Gt.class);
                startActivity(it4);
            }
        });
       /* sc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(getApplicationContext(), "신천지 교회 위치보기 입니다.", Toast.LENGTH_LONG).show();
            }
        });*/
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.sc:
                ...
                break;
            case R.id.wis:
                AlertDialog.Builder alertDialogBuiler2 = new AlertDialog.Builder(context);
                alertDialogBuiler2.setTitle("안내 사항");
                alertDialogBuiler2
                ...
                AlertDialog alertDialog2 = alertDialogBuiler2.create();
                alertDialog2.show();
                break;
            case R.id.sy:
